...
export const VILLAS: Villa[] = [
  {
    ...
    maxGuests: 8,
    description:
      "The Aloe Refuge – A Serene Nature Retreat\n\nNestled in lush surroundings, The Aloe Refuge offers a peaceful and elegant escape for families and groups of up to 8 guests.\n\nHighlights:\n• 3 comfortable bedrooms with private bathrooms.\n• Spacious open-plan living and dining area.\n• Fully equipped kitchen.\n• Free WiFi, flat-screen TV, and bed linen/towels provided.\n• Beautiful garden and outdoor terrace.\n\nThe perfect base for a relaxing getaway surrounded by nature.",
    isAvailable: true,
    color: "#3b82f6",
