...
export const VILLAS: Villa[] = [
  ...
  },
  {
    ...
    maxGuests: 8,
    description:
      "Shelter B – A Charming Retreat\n\nA beautifully appointed property offering comfort and character for families and groups of up to 8 guests.\n\nHighlights:\n• 3 cosy bedrooms with quality furnishings.\n• Warm, inviting living spaces.\n• Fully equipped kitchen.\n• Free WiFi, flat-screen TV, and all linen included.\n• Beautiful surroundings and outdoor spaces.",
    isAvailable: true,
    color: "#eab308",
