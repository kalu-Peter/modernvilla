            ...
            <div className="modal-section">
              ...
              <div className="modal-dates-bar">
                ...
                <div className="modal-date-item">
                  ...
                  <span className="modal-date-value">
                    {checkOutDate || "—"}
                  </span>
                </div>
              </div>
            ...
            <div className="modal-section">
              ...
              <div className="guest-selector">
                ...
                <div className="guest-count-display">
                  {guestCount}{" "}
                  <span>{guestCount === 1 ? "guest" : "guests"}</span>
                </div>
                <button
                  className="guest-step-btn"
                  onClick={() =>
              ...
              {tier && guestCount > tier.baseGuests && (
                ...
                >
                  +{guestCount - tier.baseGuests} extra guest
                  {guestCount - tier.baseGuests > 1 ? "s" : ""} added
                </p>
              )}
            </div>
          )}
          ...
          <div className="modal-section price-section">
            {villa.contactOnly ? (
              <>
                ...
                >
                  This property is booked directly with the owners. Contact us
                  on WhatsApp to check availability and arrange your stay.
                </p>
                <a
              ...
              <>
                ...
                {nights > 0 && (
                  <div className="price-per-night-label">
                    {formatPrice(price * nights)} total for {nights} night
                    {nights !== 1 ? "s" : ""}
                  </div>
                )}
                {tier && (
                  <div className="price-breakdown">
                    <span>
                      Base rate (up to {tier.baseGuests} guests):{" "}
                      {formatPrice(tier.basePrice)}
                    </span>
                    {tier.extraPersonFee > 0 && (
                      <span>
                        Extra guest: +{formatPrice(tier.extraPersonFee)} /
                        person / night
                      </span>
                    )}
                    {tier.extraPersonFee === 0 && (
              ...
              <div className="unavailable-message">
                This accommodation is currently unavailable for the selected
                dates.
              </div>
            )}
          </div>
